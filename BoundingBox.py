class BoundingBox:
    ...
    def calculate_rel_positions(self):
        self.rel_minX = self.minX / self.image_shape.width
        self.rel_maxX = self.maxX / self.image_shape.width

        self.rel_minY = self.minY / self.image_shape.height
        self.rel_maxY = self.maxY / self.image_shape.height

    def calculate_size(self):
        self.width = self.maxX - self.minX
        self.height = self.maxY - self.minY

        self.rel_width = self.width / self.image_shape.width
        self.rel_height = self.height / self.image_shape.height
